...
//   }
  ...
  let myStyle = {
      color:props.mode === 'dark' ?'white':'rgb(7 14 24)',
      backgroundColor: props.mode === 'dark' ?'rgb(25 30 36)':'#f8f9fa'
  }

  return (
    <div className='container' >
    <h1 className='my-3' style={{color:props.mode === 'dark' ?'white':'rgb(7 14 24)'}}>About Us</h1>
        ...
        {/**<div className="container my-3">
            <button htmlType='button' style={btnColor} className='btn my-2' onClick={toggleStyle}>{btnText}</button>
        </div> */}
    </div>
  )
}
